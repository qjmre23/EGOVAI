...
export function PrivacyPage() {
  return (
    <div className="page padded-page info-page">
      ...
      <section><h3><ShieldCheck /> What stays protected</h3><ul><li>The AI credential remains on the local server.</li><li>Only masked and synthetic profile fields enter conversational context.</li><li>Payments are fixed simulations with server-side status verification.</li><li>Status updates stay inside the prototype Notification Center.</li></ul></section>
...
export function AboutPage() {
  return (
    <div className="page padded-page info-page about-page">
      ...
      <section className="about-steps"><div><span>1</span><Bot /><strong>Ask naturally</strong><p>English, Filipino, or Taglish guidance.</p></div><div><span>2</span><MapPin /><strong>Find a schedule</strong><p>Nearby DFA offices and Slot Watch.</p></div><div><span>3</span><ShieldCheck /><strong>Pay safely</strong><p>Deterministic server-verified simulations.</p></div><div><span>4</span><BellRing /><strong>Track updates</strong><p>Passport Journey messages in the app.</p></div></section>
